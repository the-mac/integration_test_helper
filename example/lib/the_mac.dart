...
class SocialButton extends InkWell {
  SocialButton(String title, Color color, IconData icon,
    ...
    return Scaffold(
      body: ListView(
        children: [
          ...
          SocialButton('View Integration Test Helper', const Color(0xff0085E0),
              Icons.share, onTap: () {
            Navigator.push<void>(
                context,
                MaterialPageRoute(
                    builder: (BuildContext context) =>
                        const WebViewContainer(shareURL)));
          }),
          SocialButton('Check out our Facebook', const Color(0xff39579A),
              FontAwesomeIcons.facebookF, onTap: () async {
            Navigator.push<void>(
                context,
                MaterialPageRoute(
                    builder: (BuildContext context) =>
                        const WebViewContainer(facebookURL)));
          }),
          SocialButton(
              'Check out our Github', Colors.black, FontAwesomeIcons.github,
              onTap: () async {
            Navigator.push<void>(
                context,
                MaterialPageRoute(
                    builder: (BuildContext context) =>
                        const WebViewContainer(githubURL)));
          }),
        ],
      ),
    );
